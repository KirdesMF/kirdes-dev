...
function catmullRomPoint(p0: Point, p1: Point, p2: Point, p3: Point, t: number, alpha = 0.5): Point {
...
export class ElasticLines {
	...
	constructor(config?: Partial<ElasticLinesConfig>) {
		...
		this.config.color = colorWithOpacity(this.config.color, ELASTIC_LINES_OPACITY);
	}
